                ...
                <div class="card export-database">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <h4 style="margin-left:30px; margin-top:50px;">Category</h4>

                        </div>
                        <div class="col-md-6 mb-3">
                            <button class="btn btn-primary pull-right" style="margin-top:50px; margin-right:30px" ;
                                display:block;>
                                <a href="<?php echo site_url('Main/addCategory') ?>"
                                    style="color:#fff; text-decoration:none;">Add Category</a>
                            </button>
                        </div>
                    </div>
    ...
    foreach ($details as $row):
        ...
        ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo anchor("Main/deleteCategory/{$encrypted_id}", ' ', array('class' => "fa fa-trash fa-lg", 'onclick' => "return confirmDialog();")) ?>
                                        </td>
