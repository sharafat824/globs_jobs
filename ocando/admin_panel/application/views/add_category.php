<?php
    $add_edit = 'Add';
    $form = form_open_multipart('Main/addCategoryDB');
?>
    ...
    <section class="section">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url() ?>Main/Category"
                        class="text-light-color">Category</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo $add_edit; ?> Category</li>
            </ol>
        </div>
        <!--page-header closed-->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo $add_edit; ?> Category</h4>
                    </div>
                    <div class="card-body">
                        <?php echo $form; ?>
