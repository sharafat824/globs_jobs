            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single-job-list-box">
					 ...
					 <?php if($row->approve==1 and $this->session->userdata('rolecode') == 3) { ?>
                         <div class="job-btn">
                    ...
                    <?php if($this->session->userdata('rolecode') == 1 and $row->approve==1) { ?>
                         <div class="job-btn">
                            <a href="<?php echo base_url()?>Job/applicant_details/<?php echo $encrypted_id ?>" class="default-btn">View Applicants <?php echo $count_applicant_count; ?><i class="flaticon-list-1"></i></a>
                         </div>
                    <?php } ?>
