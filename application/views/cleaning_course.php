            ...
            <div class="row">
               <div class="col-lg-6 col-md-12">
                  <div class="contact-address">
                     <h3>Cleaning Work Course Information</h3>
                     <ul class="address-info">
                        <li>
                            We can help you by providing right training to work in the security industry.
                            We offer following courses:
                        </li>
                        <li>
                            <p>Sia Level 2 Door Supervisor</p>
                            <p>Nvq Level 2 Spectator Safety</p>
                            <p>First Aid</p>
                            <p>Health & Safety</p>
                            <p>Hand Cuff training</p>
                        </li>
                        <li>
                            <p>
                                We also offer fully funded courses and badge if you on job seekers or on benefits and over 18 years old ( three weeks course includes customer service, employability skills as part of funded course )
                            </p>
                        </li>
                     </ul>
                  </div>
