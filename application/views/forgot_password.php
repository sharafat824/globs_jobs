...
<body class="bg-login">
	<div class="container">
		<div class="">
			<?php echo form_open('Manage_login/email_forgot_password', 'style="margin: 355px auto 0 auto;width: 300px;"'); ?>

			<div class="container">
				<input type="text" placeholder="Enter Email" name="emailid" required>
				<a href="<?php echo base_url() ?>welcome" style="color:#fff; text-align: right">Login</a>
				<button type="submit" class="yel-btn">Submit</button>
