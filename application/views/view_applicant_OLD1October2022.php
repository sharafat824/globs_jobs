               ...
               <div class="candidates-details-sticky">
                  <div class="candidates-details-information">
                     <div class="information-box">
                        <img src="<?php echo base_url()?>employee_images/<?php echo $profile_pic ?>" alt="image">
                        <h3><?php echo $name; ?></h3>
                           ...
                           <table class="table table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="product-total">
                                    <img src="<?php echo base_url()?>employee_images/<?php echo $passport_pic; ?>" alt="image">
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="product-name">
                                    ...
                                    <td class="product-total">
                                     <img src="<?php echo base_url()?>employee_images/<?php echo $utilitybill_pic; ?>" alt="image">
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="product-name">
                                    ...
                                    <td class="product-total">
                                       <img src="<?php echo base_url()?>employee_images/<?php echo $resident_pic; ?>" alt="image">
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="product-name">
                                 ...
                                 <tr>
                                    ...
                                    <td class="product-total">
                                       <img src="<?php echo base_url()?>employee_images/<?php echo $badge_pic; ?>" alt="image">
                                    </td>
                                 </tr>
